  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        role: "assistant",
        content: `Sorry, I encountered an error: ${error.message || "Unknown error"}. Please check your API key and connection.`,
      };
            ...
            <div className="p-4 md:p-6 space-y-4">
              ...
              {messages.map((message, index) => (
                ...
                >
                  ...
                  <div className={`rounded-lg p-3 max-w-lg ${message.role === "user"
