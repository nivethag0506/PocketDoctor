...
export default function GuidePage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      // Fallback: Provide basic generic information when AI fails
      setGuide({
        medicationName: values.medicationName,
        suggestedDosage: 'As prescribed by your doctor',
        suggestedFrequency: 'Follow your doctor\'s instructions',
        timing: 'Consult your healthcare provider for optimal timing',
        food: 'Follow package instructions or consult your pharmacist',
        advantages: [
          'Treats the condition as prescribed',
          'Improves health outcomes when taken correctly',
          'Helps manage symptoms effectively'
        ],
        disadvantages: [
          'May cause side effects (consult your doctor)',
        ...
        disclaimer: 'This is general information only. AI service is currently unavailable. Always consult your doctor or pharmacist for medication-specific advice.'
      });
    } finally {
      setIsLoading(false);
    }
